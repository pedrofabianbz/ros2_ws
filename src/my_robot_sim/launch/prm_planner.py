...
# ---- MODO LAUNCH (ros2 launch my_robot_sim prm_planner.launch.py) ----
from launch import LaunchDescription
from launch.actions import ExecuteProcess, TimerAction
import os

def generate_launch_description():
    # ejecuta este mismo archivo como script tras 1 s
    this_file = os.path.realpath(__file__)
    run_prm = ExecuteProcess(cmd=['python3', this_file], output='screen')
    return LaunchDescription([TimerAction(period=1.0, actions=[run_prm])])
